...
// Runtime WCAG 2.1 AA gate for ngx-uswds-icons (GH #124). Walks every published
...
// mechanism: any pre-existing backlog is recorded, not blocking, and is burned
...
test('Storybook stories have no unresolved WCAG 2.1 AA violations', async ({ request, context }) => {
